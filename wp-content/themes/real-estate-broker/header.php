...
<body <?php body_class(); ?>>
  ...
  <header role="banner" class="position-relative">
    <a class="screen-reader-text skip-link" href="#skip_content"><?php esc_html_e( 'Skip to content', 'real-estate-broker' ); ?></a>
    <div id="header">
      <?php if( get_theme_mod('real_estate_realtor_show_topbar',true) != ''){ ?>
            ...
            <div class="row">
              <div class="col-lg-8 col-md-12 align-self-center text-center text-lg-start mb-lg-0 mb-3">
                ...
                <?php if ( get_theme_mod('real_estate_realtor_location_address','') != "" ) {?>
                  <span class="me-3"><i class="<?php echo esc_attr(get_theme_mod('real_estate_realtor_location_icon','fas fa-map-marker-alt')); ?> me-2 icon-color"></i><?php echo esc_html( get_theme_mod('real_estate_realtor_location_address','') ); ?></span>
                <?php }?>
                <?php if ( get_theme_mod('real_estate_broker_phone_number') != "" ) {?>
                  <span><i class="<?php echo esc_attr(get_theme_mod('real_estate_broker_phone_icon','fas fa-phone')); ?> me-2 icon-color"></i><a href="tel:<?php echo esc_attr( get_theme_mod('real_estate_broker_phone_number')); ?>"><?php echo esc_html( get_theme_mod('real_estate_broker_phone_number') ); ?><span class="screen-reader-text"><?php echo esc_html( get_theme_mod('real_estate_broker_phone_number') ); ?></span></a></span>
                <?php }?>
              </div>
              <div class="col-lg-4 col-md-12 align-self-center text-center text-lg-end social-icons">
      ...
      <?php }?>
      <div class="container">
        <div class="menu-header p-2 <?php if( get_theme_mod( 'real_estate_realtor_sticky_header', false) != '' || get_theme_mod( 'real_estate_realtor_display_fixed_header', false) != '') { ?> sticky-header<?php } else { ?>close-sticky <?php } ?>">
          <div class="row">
            ...
            <div class="col-lg-7 col-md-4 col-3 align-self-center">
              ...
              if(has_nav_menu('primary')){ ?>
                <div class="toggle-menu responsive-menu text-end">
                  <button role="tab" onclick="real_estate_realtor_menu_open()" class="mobiletoggle"><i class="<?php echo esc_attr(get_theme_mod('real_estate_realtor_responsive_menu_open_icon','fas fa-bars')); ?>"></i><?php echo esc_html( get_theme_mod('real_estate_realtor_open_menu_label', __('Open Menu','real-estate-broker'))); ?><span class="screen-reader-text"><?php esc_html_e('Open Menu','real-estate-broker'); ?></span>
                  </button>
                </div>
              <?php }?>
              <div id="navbar-header text-center" class="menu-brand primary-nav">
                <nav id="site-navigation" class="primary-navigation" role="navigation" aria-label="<?php esc_attr_e( 'Primary Menu', 'real-estate-broker' ); ?>">
                  <?php
                    if(has_nav_menu('primary')){
                      wp_nav_menu( array( 
                ...
                <a href="javascript:void(0)" class="closebtn responsive-menu" onclick="real_estate_realtor_menu_close()"><?php echo esc_html( get_theme_mod('real_estate_realtor_close_menu_label', __('Close Menu','real-estate-broker'))); ?><i class="<?php echo esc_attr(get_theme_mod('real_estate_realtor_responsive_menu_close_icon','fas fa-times')); ?>"></i><span class="screen-reader-text"><?php esc_html_e('Close Menu','real-estate-broker'); ?></span></a>
              </div>
            </div>
